...
- Implemented a workaround for an issue in Chrome where, upon browser restart, the tab browsing history was incorrectly appended with two additional existing tabs
